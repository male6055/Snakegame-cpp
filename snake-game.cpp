...
main_menu:
    closegraph();
    initwindow(630, 470, "Snake Game");
    setfillstyle(SOLID_FILL, BLACK);
    bar(0, 0, 630, 470); // Boundary
    ...
    outtextxy(170, 170, welcome1);
    outtextxy(190, 190, welcome2);
    outtextxy(190, 210, welcome3);
    ...
    if (GetAsyncKeyState(VK_RIGHT))
    {
        ...
        bar(620, 10, 630, 470);
        setfillstyle(SOLID_FILL, WHITE);
        outtextxy(200, 210, instructions1);
        outtextxy(200, 230, instructions2);
        outtextxy(200, 250, instructions3);
        outtextxy(200, 270, instructions4);
...
playagain:
		...
		if (score1 > highscore1)
    {
		...
		cout<<"Highest score :)"<<"  "<<highscore1<<endl;
